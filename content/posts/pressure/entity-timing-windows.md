---
title: "Pressure Entity Timing Windows — Exact Seconds to React, Hide & Escape (2026)"
description: "You heard Rush's screech but don't know if you have 2 seconds or 5. Here's every Pressure entity's exact timing window — audio cue to arrival time, how long you can hide, when it's safe to come out, and the window most players die in."
date: 2026-05-30
lastmod: 2026-05-30
draft: false
...
cover:
  ...
  alt: "Pressure Entity Timing Windows Guide Cover"
  caption: "Pressure Entity Timing"
faq:
  - question: "How many seconds do I have to hide when I hear Rush?"
    answer: "Rush gives you 3.5 seconds from the first screech to arrival. The first 1.5 seconds is the screech building up — it's quiet at first, then gets louder. By the time it's loud, you have 2 seconds left. Don't wait for the loud screech to start moving. The instant you hear ANY screech sound, identify the nearest closet and go. Rushing to a closet immediately gives you a 2-second safety margin. Waiting until the screech is loud gives you zero margin."
  - question: "How long should I stay in the closet after Ambush passes?"
    answer: "Count to 3 after each Ambush pass. If you don't hear the next distorted screech within 3 seconds, it's safe. If you do hear it, count to 3 again after that pass. Ambush passes 2-6 times total, with 2-5 seconds between passes. The fatal window: the 1-second gap between thinking 'it's done' and exiting — that's when pass 2 or 3 catches you. If in doubt, stay in 3 more seconds."
---
