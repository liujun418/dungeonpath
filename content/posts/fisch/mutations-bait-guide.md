...
games: ["Fisch"]
cover:
  image: "/cover-image/fisch-mutations/cover.webp"
  alt: "Fisch Mutations & Bait Guide Cover"
...
| Bait | Mutation | Chance | Best Rod Pairing |
|------|----------|--------|-----------------|
...
| Rod | Best Mutation | Chance | Reliable? |
|-----|--------------|--------|-----------|
...
| Enchantment | Mutation Added | Chance |
|-------------|---------------|--------|
...
| Shiny Surge | +3% Shiny attribute rate |
