---
title: "Fisch Withered Spear Guide: How to Get the 9.5x Mutation Fast, Tidefall Requirements & Spear vs Decade Rod (2026)"
description: "How to get the Withered Spear in Fisch: the 100% Tidefall bestiary unlock, the 9.5x Withered mutation value, and spear vs Decade Rod for fast cash in 2026."
date: 2026-08-20
lastmod: 2026-08-20
draft: false
...
games: ["Fisch"]
cover:
  image: "/cover-image/withered-spear-guide/cover.webp"
  alt: "Fisch Withered Spear guide cover — a glowing withered spear above a fishing spot at Tidefall"
faq:
  - question: "How do I unlock the Withered Spear in Fisch?"
    answer: "Complete the Tidefall bestiary to 100% first — catch every Tidefall species at least once. Then talk to the Tidefall Diver NPC at the Tidefall entrance and buy the spear for 1,750,000 C$. It does not appear in the shop until the bestiary is full, so if you don't see it, check your bestiary progress."
  - question: "Is the 25% Withered chance worth the -10 Handling?"
    answer: "Only if you can land your throws. The 25% roll happens only on a successful catch, and -10 Handling makes the spear minigame hard to aim, especially on rare fish. If you whiff often, the Decade Rod's 10% Withered on an easy rod minigame can out-earn it. Your aim decides whether the stat is real."
  - question: "Should I buy the Decade Rod instead of the Withered Spear?"
    answer: "If you don't have the 100% Tidefall bestiary yet, yes — the Decade Rod is the only other Withered source and has no bestiary gate. Its full stat line and acquisition are unconfirmed, but its 10% Withered chance is confirmed. Once the bestiary is done and you can aim, the spear's 25% is strictly better."
  - question: "How do I finish the Tidefall bestiary faster?"
    answer: "Sort missing species by their conditions — time of day, weather, and depth. Knock out weather-locked fish when rain, storm, or fog is live, server-hop to find the right cycle, and match bait to each species. Bank 1,750,000 C$ before your final entry so the spear isn't sitting there locked when you can't afford it."
  - question: "Does Withered stack with other mutations or attributes?"
    answer: "No. A fish gets one mutation, and a Withered roll replaces any lower-multiplier mutation. Attributes like Giant and Sparkling still stack on top of Withered, so a Giant Sparkling Withered fish is the real jackpot."
related:
...
1. **Sort missing species by condition, not rarity.** A "common" fish that only spawns in fog will stall you longer than a "rare" fish with no gates. Chase the condition, not the label.
2. **Knock out weather-locked fish the moment their weather is live.** Rain, storm, and fog windows flip constantly. When one opens, take every entry that shares it.
3. **Match bait to each species.** Some Tidefall entries flat-out won't bite without the right bait, which means you can stand in the right spot and cast the wrong thing for an hour.
4. **Server-hop for night and weather cycles.** If you need a night-only spawn and it's noon, hopping to a night server beats idling for 20 real minutes.
5. **Bank the 1,750,000 C$ before your final entry.** The spear stays visible but locked if you can't afford it, and there is nothing more annoying than finishing the bestiary and realizing you spent your wallet.

The honest summary: if you are chasing the Withered Spear for the money, understand that you will finish the bestiary *before* you buy the spear, and the bestiary itself is a money grind. The spear is a reward you earn by already having done most of the money work. We cover the general money math in our [money farming guide](/posts/fisch/money-farming-guide/).
...
If you want Withered before the bestiary is done, grab the Decade Rod and take the 10%. If you just want money, skip Withered and run a guaranteed bait setup — the [mutations and bait guide](/posts/fisch/mutations-bait-guide/) has the exact combos. And if you're still mapping out your rod route, our [rods tier list](/posts/fisch/best-rods-tier-list/) and [Cusk Purger guide](/posts/fisch/cusk-purger-rod-guide/) cover the other high-value mutation rods worth your time.
