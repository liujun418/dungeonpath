---
title: "TDS Beginner's First Week Roadmap — Exact Day-by-Day Plan From Level 1 to Your First Win"
description: "You just installed TDS and have no idea what to do first. Here is the exact day-by-day schedule for your first week — what to buy each day, which modes to grind, which towers to unlock, and the 5 traps that waste beginner coins."
date: 2026-07-17
lastmod: 2026-07-17
draft: false
author: "Alex Turner"
...
cover:
  image: "/cover-image/tds-beginner-roadmap/cover.webp"
  alt: "TDS Beginner's First Week Roadmap Cover"
  caption: "TDS Beginner's First Week Roadmap"
faq:
  - question: "Can I reach Level 20 in my first week of TDS?"
    answer: "Yes, if you follow a focused schedule and run the right modes. Playing 1-2 hours per day, you should hit Level 15-18 by Day 5 and Level 20+ by Day 7. The trick is not the number of matches — it is avoiding Easy mode (terrible EXP per minute) and focusing on Normal then Molten clears as soon as they unlock. A player who chain-runs Normal mode wins will out-level a player who sits in Easy mode farming the same first 10 waves repeatedly. If you play more than 2 hours per day or use double-EXP weekends, Level 25 is achievable in week one."
  - question: "What towers should I buy on my first day in TDS?"
    answer: "On Day 1, buy only two towers: the Minigunner (1,500 coins) and the Commander (800 coins). That is it. Do not buy Sniper, Paintballer, Scout upgrades, or any other early-game tower. The Minigunner carries your DPS for the first two weeks. The Commander's fire rate buff makes every tower better. Those 2,300 coins are the only Day 1 purchases you need. Everything else is a trap that delays your Farm and DJ — the towers that actually unlock harder modes."
  - question: "Should I spend coins on crates or skins in my first week?"
    answer: "Never. Zero coins on crates, skins, emotes, or any cosmetic item during your first week. A single crate costs 500 coins — the same as a Militant upgrade that could save a run. An emote costs 300 coins — the same as two waves of Farm income that accelerates your entire build. The only currency that matters in week one is tower unlocks and tower levels. Skins do not increase damage. Emotes do not clear waves. Cosmetics are the most efficient way to slow your progression by 30-50% without realizing it."
  - question: "What is the biggest mistake Day 1 beginners make in TDS?"
    answer: "Spending starting coins on the Sniper, Paintballer, or Scout upgrades. These towers look useful on paper — Sniper has range, Paintballer has splash — but they fall off hard after wave 15. The 2,300 coins you spend on them delays your Farm by an entire day of grinding. The correct Day 1 buy order is: Minigunner (day 1) → Commander (day 1) → Farm (day 2) → DJ (day 2-3). If you buy a Sniper on day 1, you are effectively pushing your first Molten clear from day 3 to day 5."
  - question: "What should I do if I'm stuck on Normal mode by Day 4?"
    answer: "If you are still losing Normal mode on Day 4, the problem is almost always one of three things: (1) you are not placing Farms early enough (you should have 2 level-2 Farms by wave 12), (2) you are overspending on multiple DPS towers instead of upgrading one (max Minigunner before buying a second DPS tower), or (3) you are skipping Commander and DJ entirely. Go back and check your loadout. If you have Minigunner, Commander, and Farm all placed by wave 15, you should cruise to a Normal win. If you are still losing, the issue is likely placement — make sure your towers cover a single tight chokepoint rather than scattered across the map."
  - question: "Is it worth playing Molten mode before Day 5?"
    answer: "Molten unlocks at account Level 10, which most players reach on Day 2-3 if they play efficiently. Once it unlocks, switch immediately and never look back. Molten mode gives roughly 2x the EXP of Normal mode for only 3-5 minutes longer per match. A single Molten win (500-700 coins, 18-22 minutes) is worth more than two Normal wins (400-600 coins total, 30-36 minutes total). The only exception: if you cannot survive past wave 15 in Molten, do one more Normal run to level your Farm to 2, then try Molten again."
---
...
**Your Day 4 routine:**
1. Run Molten mode twice with your five-tower core. Focus on speed — clear in under 20 minutes.
2. Buy Hunter (1,000 coins).
3. Run Molten mode once more with Hunter in your loadout. Practice spotting Hidden enemies and placing Hunter in the right spot.
4. Queue one Fallen mode attempt to see the wave patterns. Expect to lose. The goal is learning, not winning.
...
**Your Day 6 routine:**
1. Run Fallen mode 2-3 times. Try to clear each in under 25 minutes.
2. Check your tower levels. If any core towers are below Level 3, run Molten mode with that tower slotted until it levels up.
3. Claim daily rewards and check for active codes.
4. Review your loadout and identify one weakness. Do you die to air? Level your Hunter. Do you die to bosses? Level your Minigunner. Do you run out of coins? Level your Farm.
...
**Are you dying before wave 15?**
The problem is almost always your economy. Check: are you placing Farm on wave 1-3? If not, fix that first. If yes, check your Farm level — is it at least level 2 by wave 10? If your Farm is level 1, upgrade it before buying anything else.

**Are you dying between wave 15 and wave 20?**
The problem is Commander. Are you placing Commander before wave 14? If not, start doing that. The fire rate buff is the difference between killing tanky enemies and watching them leak.

**Are you dying between wave 20 and wave 25?**
The problem is DJ. Are you placing DJ before wave 18? The range buff closes coverage gaps. The upgrade discount saves you thousands of coins by endgame. If you are skipping DJ to "save coins," you are losing coins.

**Are you dying between wave 25 and wave 35?**
The problem is Minigunner level. Are you maxing your Minigunner (level 4, 3,200 coins) by wave 28? If not, the final waves will overwhelm your underleveled DPS. Prioritize one maxed DPS tower over two half-leveled towers.
