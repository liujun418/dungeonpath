...
howto:
  steps:
    - name: "Read the Full Guide"
      text: "Read this complete Tower Defense Simulator Fallen Mode Guide from start to finish. Understanding the full strategy before acting prevents costly mistakes. Pay attention to tables and tier rankings for quick reference."
...
> **Disclaimer:** Fallen strategies are based on TDS as of May 2026. Game updates may change boss mechanics, enemy stats, or tower effectiveness. Check the [official TDS Wiki](https://tds.fandom.com/) for the latest information.

Sources:
- [TDS Wiki - Fallen Mode](https://tds.fandom.com/wiki/Fallen_Mode)
