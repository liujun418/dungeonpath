...
**Engineer + Medic + Electroshocker**
Engineer's sentries do the work, but Engineer gets stunned. Medic prevents that. Electroshocker slows enemies so sentries have more time to apply damage. This trio doesn't have one massive DPS number — it has sustained DPS that never drops to zero. That's often better than burst that goes offline at the wrong second.

**Ranger + DJ Booth + Pursuit**
Ranger covers the map. DJ fixes its slow fire rate. Pursuit mops up anything that Ranger's single-target shots miss. In maps with multiple lanes or curved paths, this pair covers ground that Accelerator can't reach without awkward placement.

**Golden Minigunner + Golden Scout + Farm**
Pure gold economy comp. Golden Scout gives hidden detection and early cash. Farm accelerates your Minigunner upgrades. By Wave 30, you've got three maxed Minigunners that cost you nothing in ongoing maintenance. This comp struggles in Hardcore where early waves hit too hard for the Farm delay, but dominates Golden Mode.
...
I learned this the hard way on [Crossroads](/posts/tower-defense-simulator/tower-placement-theory/). I had six maxed towers clustered at the first turn. Wave 36's fast hidden enemies split left while my towers all fired right. Total wipe. Spreading the same six towers across the lane — same total damage, better coverage — cleared Wave 40 with towers to spare.
...
1. **Primary DPS** — Accelerator, Engineer, or Turret. One tower. Max it.
2. **Secondary DPS / Hidden** — Crook Boss, Golden Scout, or Minigunner. Covers what your primary can't hit.
3. **Buff** — DJ Booth or Commander. Non-negotiable. A DPS tower without a buff is 40% weaker than it looks.
4. **Stun / Slow Support** — Electroshocker, Freezer, or Frost Blaster. Buys time.
5. **Leak Catcher** — Pursuit or Ace Pilot. Placed near exit, not entrance.
6. **Economy or Flex** — Farm, Medic, or a second buff if the map demands it.
...
Fix one synergy this week. Move one tower into DJ range. Swap one duplicate DPS for a buff or a stun. Run [Fallen Mode](/posts/tower-defense-simulator/fallen-mode-guide/) and watch Wave 40. If the Fallen King dies before the exit, you've found your combo.
