...
games: ["DOORS"]
cover:
  image: "/cover-image/doors-crucifix-usage/cover.webp"
  alt: "DOORS Crucifix Strategy Guide Cover"
  caption: "DOORS Crucifix Strategy"
faq:
  - question: "Does the crucifix work on Seek?"
    answer: "No. Seek chases are scripted sequences. The crucifix cannot interrupt them. During a Seek chase, your only options are running, vitamins, and clean pathing. Save your crucifix for entities that can actually be banished."
  - question: "Can you use a crucifix on Figure during the Library encounter?"
    answer: "No. The Room 50 Library encounter is a stealth sequence, not a chase. The crucifix only works on Figure during the Room 100 electrical room chase sequence. If you're struggling with the Library, learn the 11-second patrol cycle instead of relying on items."
  - question: "How many crucifixes should I buy per run?"
    answer: "Buy two for a standard Hotel run — one for Ambush insurance, one for Figure or emergency Rush. Buy three if you're running The Mines or playing with modifiers that reduce hiding spots. Buy zero if you're speedrunning and relying on routing instead of items."
  - question: "What's the exact placement timing for a crucifix?"
...
The crucifix sat in your inventory for thirty doors. You bought it at Jeff's Shop, golden and heavy, promising safety. Then Rush screamed in room 45 and you panicked. You threw it. Rush vanished in golden light. You felt brilliant.

Now Ambush is coming. The hallway stretches empty. No closets. No side rooms. You hear that awful distorted static that means Ambush is bouncing toward you, fast and unpredictable. Your hand moves to the crucifix key. You hesitate.

"What if Figure needs it more?"

That hesitation costs you everything. Ambush rounds the corner. You try to place the crucifix but your fingers fumble. The animation starts. Ambush doesn't care about animations. Black screen.

This is the crucifix in a nutshell. It's the most misunderstood item in DOORS because it demands a decision before you're ready to make one. Hoard it and die with it in your pocket. Waste it and die wishing you had it. This guide fixes both problems.

---

## What the Crucifix Actually Does
...
## The Entity List: Who Dies and Who Laughs

Here's exactly which entities the crucifix affects. No guessing. No community myths.

**Banishable (use it here):**

- **Rush** — Yes. The most common target. Also the most common waste.
- **Ambush** — Yes. High-value target. Unpredictable bounces make closets unreliable.
- **Figure** — Yes, but **only during the Room 100 electrical room chase**. Not in the Library. Not during cutscenes.
- **Screech** — Yes. A total waste. Just look at it.
- **Eyes** — Yes. Another waste. Walk around it.
- **Dupe** — Yes. Only worth it if you're trapped in a dead-end with no other exit.

**Not Banishable (don't even try):**

- **Seek** — No. The chase is scripted. The crucifix does nothing.
- **Halt** — No. Back up. That's the entire mechanic.
- **Timothy** — Technically yes, but why would you?
- **Grumble (The Mines)** — No. Freeze and wait.
- **Giggle (The Mines)** — No. Sprint through.
- **Snare (The Mines)** — No. Watch your step.

The pattern is simple: if the entity is a chase or ambush threat, the crucifix probably works. If it's a puzzle or environmental hazard, it doesn't.
...
**The 2-3 second rule:** Place the crucifix 2-3 seconds before the entity enters your line of sight. This accounts for the 1.5-second wind-up and gives the entity time to path into the light field. Place it too early and the light fades before the entity arrives. Place it too late and you're dead before the wind-up finishes.

**Positioning guidelines:**

- **For Rush:** Place it in the middle of a long hallway, not near doorways. Rush's hitbox is slightly behind its visual model. Doorway placements often miss because Rush's center mass hasn't crossed the light yet.
- **For Ambush:** Place it where you think the *second* bounce will land, not the first. Ambush's first pass is fast. By the time you react, it's gone. The second bounce is slower and more predictable. If you're going to crucifix Ambush, you're trading for the second pass, not stopping the first.
- **For Figure (Room 100):** Place it during the chase sequence when Figure is at least 15 studs behind you. Figure's speed during the chase is slower than Rush, so you have slightly more time. But Figure's hitbox is larger, so the placement window is actually more forgiving.
...
## Failure Analysis: The 3 Patterns That Waste Crucifixes

These are the mistakes I see in spectated runs, in my own early games, and in every Discord clip titled "crucifix bugged." The crucifix isn't bugged. The player is predictable.

**Pattern 1: The Rush Panic Throw**

Rush screams. The player has a crucifix. Their brain short-circuits and they throw it immediately, often missing the placement or using it in a room with three closets nearby. Then they die to Figure later because the crucifix is gone.

**The fix:** Rush gives you 3.5 seconds from screech to contact. That's enough time to locate a closet, decide if you need the crucifix, and place it correctly. Count to two before you commit. If a closet is visible, go to the closet. The crucifix is your backup plan, not your primary defense.

**Pattern 2: The Figure Hoard**
...
Here are five things about the crucifix that sound wrong until you test them.

**Sometimes wasting a crucifix is better than losing a run.** If you're at door 95, you've got great loot, and Rush spawns in a bad room, using a crucifix on Rush isn't optimal — but it might be correct. "Optimal" is for speedruns. "Correct" is for runs you want to finish. One suboptimal crucifix use is cheaper than restarting from door 1.
