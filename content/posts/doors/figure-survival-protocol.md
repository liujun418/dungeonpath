---
title: "Figure Keeps Killing You on Room 50? Here's the Rhythm That Beats Him Every Time (2026)"
description: "You're not dying because you're bad at stealth. You're dying because you're treating Figure like a hiding game when it's actually a rhythm puzzle. Here's the exact patrol pattern, the 11-second cycle, and how to move during every phase without getting caught."
date: 2026-06-02
lastmod: 2026-06-02
draft: false
author: "Alex Turner"
...
games: ["DOORS"]
cover:
  image: "/cover-image/doors-figure-survival/cover.webp"
  alt: "DOORS Figure Survival Protocol Guide Cover"
  caption: "DOORS Figure Survival"
faq:
  - question: "How many seconds do I have before Figure detects me if I sprint?"
    answer: "Zero seconds if Figure is in its listening phase. During the walk phase, you have about 1.5 seconds of sustained noise before detection triggers — Figure's own footsteps partially mask your sound. During the listen phase (every ~11 seconds), detection is instant. This is why most players die: they sprint during a listen phase when Figure just stopped moving, and they're caught before they can react. The rule: only move during Figure's walk phase. When it stops, you stop. No exceptions."
---
...
1. **Sprint to the OPPOSITE end of the Library.** Not away from Figure — away from your current position, toward the farthest corner. Figure charges in a straight line toward your last known position. If you change direction sharply after the roar, Figure overshoots.

2. **Break line of sight behind 2+ rows of shelves.** One row isn't enough — Figure's detection radius extends through a single shelf row. Two rows is clean break.

3. **Throw any item in your inventory toward the FARTHEST corner from your hiding spot.** The noise creates a decoy. Figure investigates impacts for 5-7 seconds.

4. **Crouch behind a shelf and DON'T MOVE for 15 seconds.** Even after Figure's footsteps move away. Figure is extra-cautious for 10-15 seconds after a detection. If you move at second 8 because it "sounds far away," you'll trigger a second detection. Second detections are almost always fatal.

5. **After 15 seconds of silence, resume the protocol.** One detection resets Figure's alertness but doesn't end the run. Two detections in quick succession usually does.
...
- [DOORS Room 50 Library Walkthrough — Book-by-Book Guide](/posts/doors/room-50-library-walkthrough/)
