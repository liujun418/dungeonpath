---
title: "Doors Pre-Run Preparation & Checklist Guide: Survive Past Door 10"
description: "Master the lobby shop with our item priority tier list, gold budgeting tips, team role assignments, and the pre-run checklist that stops early deaths in Doors."
date: 2026-07-08
lastmod: 2026-07-08
draft: false
author: "Alex Turner"
...
games: ["Doors"]
cover:
  image: "/cover-image/doors-pre-run-preparation/cover.webp"
  alt: "Doors Pre-Run Preparation and Checklist Guide"
  caption: "Doors Pre-Run Preparation and Checklist Guide"
faq:
  - question: "What should I buy first if I only have 100 gold in Doors?"
    answer: "Buy Vitamins first. Speed is the single most powerful survival tool in the game, and Vitamins let you outrun Seek during chase sequences, reposition around Figure, and recover from bad door timings. If you have gold left after Vitamins, buy a Lighter. Never enter a run without at least one reliable light source."
  - question: "Do I need a Flashlight if someone else on my team already has a Lighter?"
    answer: "No. The Flashlight is a luxury item, not a necessity. It costs significantly more than the Lighter, drains batteries permanently, and the improved range does not help you survive Rush, Ambush, or Seek any better than a Lighter does. Let one player carry the Lighter as the Scout, and spend your saved gold on Vitamins or a Crucifix instead."
  - question: "Which modifiers should beginners always disable before a standard Doors run?"
    answer: "Disable anything that increases entity aggression, removes closets, or restricts vision. Specifically avoid 'Rush Hour' style modifiers that increase spawn rates, 'No Closets' variants, and 'Darkness' modifiers that remove ambient light. These modifiers are designed for challenge runs and will kill inexperienced players before Door 10."
  - question: "How do we decide who carries the Crucifix in a team?"
    answer: "The Anchor carries the Crucifix. This is the player who stays at the back of the group, covers retreats, and is the last into closets. Because the Anchor sees threats coming before anyone else and is responsible for covering the team's escape route, they are in the best position to use the Crucifix when something goes wrong. Never give the Crucifix to the Scout, who is too far ahead to save anyone but themselves."
  - question: "Is it worth buying items if I am playing solo in Doors?"
    answer: "Absolutely. Solo players actually need items more than teams do. In a group, teammates can share light sources and call out entity warnings. Alone, you are responsible for every survival layer. Prioritize Vitamins and a Lighter every run. Once you have a gold surplus, add a Lockpick and eventually a Crucifix. Solo runs without items are essentially hard mode."
  - question: "Why do I keep dying before Door 10 even though I bought a Lighter?"
    answer: "A Lighter helps you see, but it does not save you from every threat. Most early deaths happen because players buy a Lighter and then stand in the open during Rush, or they panic and hide in the wrong closet because they have no Vitamins to reposition. Light shows you the danger. Speed gets you away from it. You need both. Also check your modifiers—accidental hard-mode toggles will kill even prepared players."
  - question: "Should I save gold for future runs or spend it all before entering the elevator?"
    answer: "Spend it all. Gold has zero value inside a run. The 200 gold you save for 'next time' cannot resurrect you when Figure catches you at Door 47. Convert every piece of gold into survival items before the elevator doors close. Future runs are only possible if you survive the current one."
---
...
**Skipping the Lobby Shop Entirely**
New players treat the lobby as a social space. They stand around, emote, and walk into the elevator empty-handed. By Door 5 they are fumbling in absolute darkness. By Door 8, Rush spawns and they have no light source to identify which closet is closest. They die not because Rush is unfair, but because they entered the hotel blind.

**Buying the Wrong Items First**
The Flashlight looks like the obvious choice. Better range, brighter beam, professional feel. But it costs three times what a Lighter costs, drains batteries that cannot be refilled mid-run, and does not solve the actual threats in the hotel. Darkness slows you down. Entities kill you. Spending half your budget on a slightly better light while skipping speed and safety items is like buying a better umbrella for a house fire.

**No Team Role Assignments**
Everyone buys a Lighter. Nobody buys Vitamins or a Crucifix. When Ambush arrives, four players try to wedge into the same closet while carrying redundant light sources. Meanwhile, the door to Room 15 stays locked because no one brought a Lockpick, forcing the team to backtrack through rooms they already cleared while Rush is active.

**Entering Without a Light Source**
Some players buy a Candle and assume they are covered. A Candle warns of approaching entities by turning blue, but it does not illuminate closets, door numbers, or drawer locations in dark rooms. You cannot hide from what you cannot see. A Candle is a supplement, not a replacement.

**Ignoring the Pre-Run Checklist**
Players treat each run as a fresh reset with no carryover responsibility. They do not check the team's combined loadout, do not agree on who opens doors, and do not verify whether the host accidentally left a challenge modifier active. The elevator becomes a trap disguised as a doorway.
...
- [Doors Beginner Mistakes Guide](/posts/doors/beginner-mistakes-guide/)
