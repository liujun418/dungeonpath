...
If you're new to DOORS, start with our [DOORS Beginner Guide](/posts/doors/beginner-guide/) to learn the fundamentals before tackling alternate modes.
...
- **Know your entity pool** — since entities can come from any floor, you need familiarity with Hotel, Mines, and Outdoors threats. See our [DOORS Entities Bestiary](/posts/doors/entities-bestiary/) for complete entity information.
...
For entity-specific survival techniques, see our [DOORS Entities Bestiary](/posts/doors/entities-bestiary/).
...
- [DOORS Beginner Guide (2026)](/posts/doors/beginner-guide/) — Master the fundamentals first
- [DOORS Entities Bestiary](/posts/doors/entities-bestiary/) — Learn every entity's behavior and counters
- [DOORS Speedrun Guide](/posts/doors/speedrun-guide/) — Optimize your clear times for leaderboard runs
- [DOORS Modifiers Guide](/posts/doors/modifiers-guide/) — Customize your runs with difficulty modifiers
