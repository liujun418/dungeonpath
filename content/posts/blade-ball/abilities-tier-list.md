...
1. **Don't waste your ability early** — save it for when the ball is at maximum speed (3+ deflections)
2. **Learn the cooldown** — each ability has a cooldown timer. Don't use it again until it's fully recharged
3. **Combine with movement** — using an ability while moving unpredictably makes you much harder to hit
