---
title: "Lethal Company Quota Management Guide: The 'Sell vs Push' Math That Stops Team Wipes"
description: "Your team didn't wipe because of a Giant — you wiped because you pushed for 70 extra credits on a 60% risk moon. This Lethal Company quota guide covers the profit-per-moon math, sell-vs-push decision framework, and exactly when to take the safe money."
date: 2026-06-27
cover:
  image: "/cover-image/lc-quota-optimization/cover.webp"
  alt: "Lethal Company Quota Management Guide Cover"
...
faq:
  - question: "Is this Lethal Company quota guide up to date for 2026?"
    answer: "Yes, this guide reflects the current state of Lethal Company in 2026. We track patches and updates to keep information accurate. Check the last modified date at the top of the page."
  - question: "How does quota scaling work in Lethal Company?"
    answer: "Each successive quota increases by a semi-random multiplier based on how much you exceeded the previous quota. This guide explains the exact scaling math and how to manage it."
  - question: "Should I sell scrap if I'm only 50 credits short of quota?"
    answer: "Yes. Selling at 90% of quota and taking the partial save is almost always better than risking a full wipe for a small shortfall. One bad trip can erase days of progress."
  - question: "Does overshooting quota actually make the game harder?"
    answer: "Yes. Lethal Company's quota scaling uses an overshoot multiplier — typically 0.4 to 0.6 — which inflates your next quota based on how much you exceeded the previous one. Consistently hitting quota by 5-15% produces a much easier campaign than spiking 30-40% over."
  - question: "Where can I find more Lethal Company guides?"
    answer: "We maintain a full library of Lethal Company guides covering moons, entities, equipment, terminal commands, and more. Check the Related Guides section below."
---
...
- [Lethal Company Moon Tier List: Best Moons for Scrap and Survival](/posts/lethal-company/moon-tier-list-scrap-survival)
- [Lethal Company Scrap Value Guide: Every Item Ranked by Profit](/posts/lethal-company/scrap-value-guide-every-item-ranked)
- [Lethal Company Daylight and Weather Mechanics Explained](/posts/lethal-company/daylight-weather-mechanics-guide)
- [Lethal Company Beginner's Guide: First 5 Days Without Wiping](/posts/lethal-company/beginners-guide-first-5-days)