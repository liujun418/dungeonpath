---
title: "Lethal Company Stealth & Evasion Guide: Survive Without Fighting"
description: "Master Lethal Company stealth: crouch mechanics, sound management, LOS breaking, and monster-specific evasion tactics to survive without fighting."
date: 2026-07-07
lastmod: 2026-07-07
draft: false
...
cover:
  image: "/cover-image/lethal-company-stealth-evasion/cover.webp"
  alt: "Lethal Company Stealth and Evasion Guide"
  caption: "Lethal Company Stealth and Evasion Guide"
faq:
  - question: "Does crouching actually make you silent to monsters in Lethal Company?"
    answer: "Crouch-walking dramatically reduces footstep noise radius. Most interior monsters like the Bunker Spider and Thumper have a much harder time detecting crouched movement. However, crouching does not silence dropped items, door slams, or voice chat."
  - question: "Can Eyeless Dogs hear you through voice chat?"
    answer: "Yes. Eyeless Dogs are completely blind but react to any sound in their radius, including proximity voice chat, footsteps, dropped scrap, and ladder noises. If you are near a Dog, mute your mic and crouch-walk. Walkie-talkie transmissions do not emit local sound, but yelling into the walkie near a teammate who is standing next to a Dog will get them killed."
  - question: "Which monsters can you outrun and which should you never sprint from?"
    answer: "You can outrun Hoarding Bugs, Snare Fleas, and Bunker Spiders in a straight sprint. Thumpers are faster than you in straight lines but terrible at turning, so you can outmaneuver them. Brackens, Coil-Heads, and Jesters should never be sprinted from blindly; Brackens require line-of-sight breaking, Coil-Heads require you to freeze and maintain eye contact, and Jesters require you to leave the facility entirely once wound up."
  - question: "Does hiding in a locker work against every monster?"
    answer: "Lockers work against most interior monsters including Brackens, Bunker Spiders, and Thumpers, provided the monster did not see you enter. However, the Jester will eventually kill everyone inside the facility regardless of hiding spots, and the Ghost Girl ignores hiding spots entirely once her timer expires. Lockers also do not protect against Forest Giants or Eyeless Dogs outside."
  - question: "Is it better to freeze or run when a monster sees you?"
    answer: "It depends entirely on the entity. Freeze and maintain eye contact for Coil-Heads. Break line of sight and hide for Brackens. Run and make sharp turns for Thumpers. Stand perfectly still on elevated rocks for Earth Leviathans. Sprint for the ship or main entrance against a winding Jester. There is no universal rule; using the wrong response is usually fatal."
  - question: "Do dropped items make noise that monsters can hear?"
    answer: "Yes. Dropping scrap or equipment emits a short-range sound cue that attracts sound-based monsters like Thumpers, Bunker Spiders, and Eyeless Dogs. Throwing items makes even more noise. If you need to drop something silently, crouch first and look straight down to minimize the drop distance and impact sound."
  - question: "How do you break line of sight against a Bracken?"
    answer: "Close doors behind you, round corners sharply, duck into side rooms, or hide in a locker. The Bracken loses interest quickly if it cannot see you for a few seconds. Simply sprinting in a straight line down a long hallway usually does not work because the Bracken moves fast and will snap your neck once it gets within melee range."
---
...
Mastering stealth is only one part of surviving the company. For a complete breakdown of every threat and how to counter them, read our [Lethal Company Entity Counter Playbook](/posts/lethal-company/entity-counter-playbook/). If you are still learning the basics, start with the [Lethal Company Beginner Guide](/posts/lethal-company/beginner-guide/) and avoid the common pitfalls in our [Beginner Mistakes Guide](/posts/lethal-company/beginner-mistakes-guide/).

For team coordination, check out the [Communication Signals Guide](/posts/lethal-company/communication-signals-guide/) and [Co-op Team Roles Guide](/posts/lethal-company/coop-team-roles-guide/). Understanding who should be crouch-walking and who should be watching cameras is the difference between a clean extract and a total party wipe. Solo players should read the [Solo Survival Guide](/posts/lethal-company/solo-survival-guide/) for stealth tactics tailored to lone operatives.

If you want to optimize your loot routes so you spend less time in monster territory, see our [Scrap Route Optimization](/posts/lethal-company/scrap-route-optimization/) and [Interior Layouts Guide](/posts/lethal-company/interior-layouts-guide/). Finally, for the economic side of staying alive, the [Equipment Economy Guide](/posts/lethal-company/equipment-economy-guide/) explains which tools are worth buying to support a stealth-heavy playstyle.
