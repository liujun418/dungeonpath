---
title: "Lethal Company Complete High Quota & Late Game Guide — Surviving When Every Run Is a Death Sentence (2026)"
description: "Quota 8. Your crew needs 1,250 credits. You have 6,000 in the bank. Credits aren't the problem — survival is. Here's the complete late-game guide: moon selection when every moon is eclipsed, equipment priorities when losing a shovel hurts more than losing a run, and the mindset shift that separates quota 8 crews from quota 15 crews."
date: 2026-07-18
lastmod: 2026-07-18
draft: false
author: "Alex Turner"
...
cover:
  image: "/cover-image/lc-high-quota-late-game/cover.webp"
  alt: "Lethal Company High Quota Late Game Guide — crew huddling on a cramped moon with escape lights visible"
  caption: "The late game isn't about scraping together credits anymore — it's about keeping your crew alive long enough to collect them"
faq:
  - question: "How does the game change when quota reaches 1000+ in Lethal Company?"
    answer: "The game flips entirely. Credits stop being the bottleneck — most experienced crews have 3,000-8,000 in the bank by quota 8. Survival becomes the only resource that matters. You stop optimizing scrap per minute and start optimizing survival probability per run. Moon selection shifts from 'which moon has the best scrap?' to 'which moon has the highest chance of everyone returning alive?' Equipment priorities shift from looting tools to escape tools. The cost of a single death at quota 12 is not the scrap they were carrying — it's the equipment they were wearing, the time pressure on the remaining crew, and the spiral that turns a 2-player deficit into a full wipe."
  - question: "What's the best moon for high quota runs (quota 8+) in Lethal Company?"
    answer: "Rend is the best moon for quota 8-12 consistency. It costs 550 to land, has B-tier hazard, and averages 800-1,100 scrap per run. Titan has better scrap potential (1,200-1,600) but its S+ hazard means you're gambling the entire run every time you land. At high quotas, the play is to hit Rend on Day 1, fill 70% of quota, then decide Day 2-3 based on weather. If Rend is eclipsed or stormy, March or Offense with a double-run strategy is safer than forcing a bad-weather Rend. Artifice is the end-game moon for quota 15+ crews, but only if you have 4 experienced players and a dedicated ship operator."
  - question: "Does overshooting quota make the late game harder in Lethal Company?"
    answer: "Yes, significantly. Each quota scales based on how much you exceeded the previous one. A 30-40% overshoot can inflate your next quota by 100-200 credits — that's an extra day of risk on an already deadly moon rotation. At high quotas, a 200-credit overshoot is the difference between needing 1,200 and needing 1,400. That extra 200 credits means an extra facility entry, which is where crews die. The optimal play at late-game quotas is to hit quota by 5-15% and no more. Sell early, sell often, and leave extra scrap on the ship for next quota instead of overshooting by a mile."
  - question: "What equipment should I prioritize in the late game (quota 8+)?"
    answer: "The late-game equipment priority list flips completely from the early game. Top priority: Stun Grenades (30 credits each, buy 2-3 per crew) for emergency escapes from Giants and Jesters. Second priority: Zap Guns (50 credits) for locking down Coil-Heads during extraction. Third: Pro-Flashlights (45 credits) — at high quotas, the brightness difference saves seconds, and seconds are lives. Fourth: Walkie-Talkies for every player — the ship operator is your most important role at high quota, and dead comms is a wipe. The Shovel drops from S-tier to C-tier at high quota because you should not be fighting anything at quota 8+ — you should be stunning and running. If you're in shovel range of an entity, you've already made a positioning mistake."
  - question: "How many crew members do I need for quota 10+ runs?"
    answer: "Minimum 3 experienced players, ideally 4. Two-player high quota runs are possible but the survival rate drops below 30% at quota 8+ because a single death leaves one player to loot an entire facility alone. With 4 players, one serves as dedicated ship operator (radar, teleport, door control) while 3 loot as a tight group. The ship operator role becomes non-negotiable at quota 10+ — without someone watching radar, a Bracken flank or Coil-Head trap wipes the team in seconds. If you only have 2 players, your best strategy is to stay on safe moons (March, Offense) and accept that quota 10 is your ceiling."
  - question: "When should I abandon a high quota run entirely?"
    answer: "Abandon the run (take the quota fail) when two conditions are met: (1) it's Day 3 with over 40% of quota remaining, and (2) the only viable moons are eclipsed or stormy with no safe alternative. In this scenario, a Day 3 forced run on a dangerous moon has roughly a 35% survival rate. Taking the quota fail, restarting with your credit surplus intact, and beginning a fresh quota cycle is often the correct play. Your credit bank absorbs the fail. Your crew lives to try again. The sunk-cost fallacy of 'we've come this far' kills more late-game runs than any entity. The math is simple: a 35% chance to survive the run vs. a 100% chance to survive the restart."
  - question: "How does weather affect moon choice differently in the late game?"
    answer: "Weather becomes the single most important factor in moon selection at high quotas. A clear-sky Rend is the best moon in the game. An eclipsed Rend is a death trap — the constant entity spawns inside the facility mean you're fighting Coil-Heads and Nutcrackers from the moment you enter. Foggy moons are also disproportionately dangerous at high quota because outdoor extraction becomes a guessing game against Forest Keepers. The late-game weather rule: if the best available moon has bad weather, take a safe moon with good weather instead. Offense on a clear day with 800 scrap potential beats Rend on an eclipsed day with 500 scrap potential — because your crew actually survives Offense."
  - question: "Is Artifice worth landing on for high quota runs?"
...
related:
  guides:
    ...
    - "Moons Profit Tier List": "/posts/lethal-company/moons-profit-tier-list/"
---
...
| Moon | Landing Cost | Avg Scrap Full Clear | Hazard | Late-Game Verdict |
|---|---|---|---|---|
| **Rend** | 550 | 800-1,100 | B | **Best all-rounder.** Clear skies = go. Eclipsed or stormy = skip. |
| **Offense** | 40 | 500-750 | C | **Reliable fallback.** Low hazard, fast extraction, consistent returns. |
| **March** | Free | 400-700 | C | **Emergency option.** No landing fee means zero financial risk. Double-run for safety. |
| **Titan** | 700 | 1,200-1,600 | S+ | **Win-more moon.** Only go when quota is already 70%+ met and weather is clear. Never Day 1. |
| **Artifice** | 1,200 | 1,500-2,000 | S | **Flex moon.** Quota 15+ only. Never when quota is the pressure. |
| **Rend (bad weather)** | 550 | 300-500 | C→S | **Trap.** Bad weather makes Rend more dangerous than Titan with half the scrap. Skip. |
...
| Priority | Item | Cost | Why It Matters at High Quota |
|---|---|---|---|
| **1** | Stun Grenade | 30 | Your only reliable escape from Giants, Jesters, and Forest Keepers. Buy 2-3 per crew. |
| **2** | Zap Gun | 50 | Locks down Coil-Heads permanently during extraction. Buy 1 for the ship operator. |
| **3** | Pro-Flashlight | 45 | At high quota, the extra brightness radius gives you 0.5-1 second more reaction time. That's a life. |
| **4** | Walkie-Talkie | 12 | Every player must have one. Dead comms at high quota = guaranteed positional death. |
| **5** | Shovel | 30 | Drops from S-tier to C-tier. You should not be fighting at quota 8+. Stun and run. |
