---
title: "BBF Wave Strategy & Enemy Counter Guide: Never Leak Again"
description: "Wave 28 leaks cost you the run at wave 30. Here is every BBF enemy type, the exact Titan counter for each wave stage, and the wave-by-wave strategy that stops leaks."
date: 2026-07-14
lastmod: 2026-07-14
draft: false
...
cover:
  image: "/cover-image/bbf-wave-strategy-enemy-counter/cover.webp"
  alt: "BBF Wave Strategy and Enemy Counter Guide"
  caption: "BBF Wave Strategy and Enemy Counter Guide"
faq:
  - question: "Why do I leak enemies on wave 15 when my Titans are maxed?"
    answer: "Wave 15 is the first Fast Swarm wave. Maxed Titans do not matter if you deployed Titan Cameraman, which has slow attack speed and misses small, fast targets. You need Upgraded Speakerman or Titan TV Man for swarm waves. Single-target DPS Titans cannot hit fast enemies reliably. Swap your deployment before wave 15 spawns, not after the leak."
  - question: "Which Titan counters flying enemies in Blockade Battlefront?"
    answer: "Upgraded Cameraman is the only Titan with consistent anti-air tracking. Its beam locks onto flying targets and does not miss. Titan Speakerman's sonic blast also hits air but has an 8-second cooldown, making it a supplement, not a primary counter. Never rely on melee Titans like Drill Man or Jetpack Double Plunger for air waves — they will leak 100% of the time."
  - question: "Should I save my Titan for the boss wave or use it on wave 19?"
    answer: "Use it on wave 19. The boss wave at 20 is a stat check, not a DPS race — any reasonably upgraded Titan can tank it while your team focuses fire. Wave 19, however, is the first double-lane pressure wave with mixed fast enemies and a mini-brawler. Leaking wave 19 costs you base HP and forces you to spend Cen on emergency repairs instead of boss-wave preparation. Deploy on 19. Repair on 20."
  - question: "How do I stop enemy Titans from walking through my entire lane?"
    answer: "Enemy Titans are not cleaved down by AoE. They require concentrated single-target damage and a meat shield. Place Titan Drill Man at the chokepoint closest to the enemy spawn — its armor pierce ignores the enemy Titan's innate 30% damage reduction. Place Upgraded Cameraman at maximum range behind Drill Man. Never split damage between the Titan and adds. Focus the Titan until it dies, then clean up the adds. Splitting damage is why enemy Titans walk through your lane."
  - question: "Why does my Upgraded Cameraman die to wave 25 normal enemies?"
    answer: "Because wave 25 introduces Shielded Shooters, and Cameraman's beam does not break shields. The shield absorbs the first 3 seconds of beam damage, which gives the shooters enough time to kill Cameraman at close range. The counter is Titan Speakerman's sonic blast, which shields on impact, or Drill Man's drill, which pierces shields entirely. Send Drill Man first, break the shield, then let Cameraman beam the exposed target."
---
