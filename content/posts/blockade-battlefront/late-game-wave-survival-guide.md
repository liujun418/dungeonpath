...
cover:
  image: "/cover-image/bbf-late-game/cover.webp"
  alt: "Blockade Battlefront late game battle with Titans and explosions"
  caption: "Blockade Battlefront — Late Game Survival"
comments: true
howto:
  steps:
    - name: "Secure Your Econ Before Wave 40"
      text: "Waves 25-40 are your last chance to farm Cen efficiently before difficulty spikes. Make sure you have the Minigun + Bazooka combo, at least two Titans (Titan Cameraman + Jetpack Double Plunger), and a healthy ammo stockpile before wave 41 begins. If you're short on Cen, farm waves 25-35 aggressively — these are the sweet spot for risk-free income."
    - name: "Identify the Wave Type and Swap Loadout"
      text: "Waves in Blockade Battlefront fall into three categories: Standard (mixed enemies), Swarm (large numbers of fast, weak enemies), and Boss (every 5th wave, includes a major boss + adds). Swap to Bazooka for Swarm waves and Minigun for Boss waves. Check the wave number counter at the top of the screen to anticipate what's coming next."
    - name: "Rotate Titans on Cooldown"
      text: "In late game, your Titans are your most valuable assets. Never let all Titans die at once — stagger their deployments so at least one is always active. When a Titan's HP drops below 30%, prepare to deploy the next one. Repair Titans at the helicopter whenever possible."
    - name: "Execute Boss Wave Protocols"
      text: "Every 5th wave features a boss with unique mechanics. When the boss spawns: (1) All players immediately focus-fire the boss, (2) The tank player draws aggro while others spread out to avoid AoE, (3) Deploy your highest single-target damage Titan (Utam) specifically for the boss phase. Ignoring the boss to clear adds is the #1 cause of late-game wipes."
  tools:
    - "Minigun + Bazooka weapon combo"
    - "Titan Cameraman (tanking + consistent damage)"
    - "Jetpack Double Plunger Titan (mobility + burst)"
    - "Utam Titan (boss-killer for every 5th wave)"
    - "Large Cam character with Villain Arc skin (18k F-skill nukes)"
faq:
  - question: "What's the hardest wave in Blockade Battlefront?"
    answer: "Wave 90, known as the 'Hell Wave,' is universally the hardest. It features Dr. Toilet alongside every other boss in the game simultaneously. Clearing it requires Uptati (100M skin Uptake Titan) or a coordinated team with at least 3 Special Titans. Most experienced players consider wave 90 a full-team coordination check. The reward for beating it is the exclusive 'Burning Flame' item."
  - question: "How do I survive past wave 50 consistently?"
    answer: "Consistent wave 50+ survival requires three things: (1) A fully upgraded loadout — Minigun + Bazooka + at least two Titans; (2) A character with a Legendary or Mythic skin, preferably Dark Speakerman (MYTHICAL) or Energize TV Man (Titan Replica); (3) A coordinated team of 3-4 players who understand their roles. Solo play past wave 50 is extremely difficult regardless of loadout — the enemy density and damage scaling is balanced around multiplayer."
  - question: "What happens after wave 90 in Blockade Battlefront?"
