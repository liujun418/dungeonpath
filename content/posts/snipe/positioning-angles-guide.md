...
games: ["Snipe"]
cover:
  image: "/cover-image/snipe-positioning-angles/cover.webp"
  alt: "Snipe player holding an off-angle position with sightline visualization"
  caption: "Power positions are death traps — off-angles win fights"
---
...
If you're still gunfighting from the textbook spots, the [Snipe ranked climbing guide](/posts/snipe/ranked-climbing-guide/) won't help you past Platinum. Positioning is the wall.
...
The best head-glitches on every map are unlabeled. They look like terrain. That's why they work. The [map mastery guide](/posts/snipe/map-mastery-guide/) covers the geometry — this is what to do *with* it.
...
| Map | Textbook Spot (Avoid) | Off-Angle Replacement |
|---|---|---|
| Refinery | Catwalk over mid | Forklift gap, B-side service door |
| Docks | High container A | Low container gap, B-alley skew |
| Outpost | Bunker rooftop | Slope dip behind the radio tower |
| Old Town | Bell tower window | Café balcony rail, half-crouch |
| Subway | Platform end | Maintenance hatch at track level |
| Quarry | Crane platform | Rock outcrop south of the pit |
...
This ties into [movement mechanics](/posts/snipe/movement-mechanics-guide/) — slide-cancels and crouch-strafes are how you break sightlines, not just how you dodge.
...
This is the same logic [advanced techniques](/posts/snipe/advanced-techniques-ranked-guide/) covers for jiggle-peeking — small movements break pre-aimed crosshair placement at range.
...
If you're still picking up the basics — recoil patterns, weapon selection, the rank structure — read the [beginner guide](/posts/snipe/snipe-beginner-guide/) and [weapons tier list](/posts/snipe/weapons-tier-list/) first. Positioning sits on top of fundamentals. It doesn't replace them.
