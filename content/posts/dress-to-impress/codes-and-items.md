...
| Code | Reward | Notes |
|------|--------|-------|
| **SEASHELL** | Seashell-themed items | Summer event code |
...
|------|----------------|
| `NEWYEAR2026` | New Year outfit pieces |
| `HOLIDAY2025` | Holiday-themed items |
| `HALLOWEEN2025` | Halloween accessories |
| `SUMMER2025` | Summer seashell items |
| `LAUNCH` | Launch day outfit |
...
| "Invalid code" | Typo in the code | Copy the code exactly |
| No response | Code may be inactive | Try again later or check for new codes |
...
| Item Type | Examples |
|-----------|----------|
| **Tops** | Seasonal blouses, themed shirts |
| **Bottoms** | Holiday skirts, event-themed pants |
| **Dresses** | Full outfits for special occasions |

### Accessories

| Item Type | Examples |
|-----------|----------|
| **Headpieces** | Seashell Crown, holiday hats |
| **Jewelry** | Event-themed necklaces, earrings |
| **Bags** | Seasonal purses and handbags |

### Seashells

Some codes award seashells, the in-game collectible currency:

- Seashells can be used to purchase exclusive items from the seashell shop
- Collect enough seashells to unlock rare outfit pieces
- Seashell packs are available during summer updates
...
|----------|---------------|
| **TikTok** | Search "DTI codes" — community creators post codes quickly |
...
Seashells are a special currency in DTI that can be earned through codes, events, and hidden collectibles.

### How to Earn Seashells

| Method | Amount | Notes |
|--------|--------|-------|
| **Codes** | 10-50 seashells | Varies by code |
| **Hidden collectibles** | 50-200 seashells | Find all 3 seashells + treasure chests in the lobby |
| **Treasure Hunt events** | 100-200 seashells | Scarlet's Treasure Hunt events |
| **Daily rewards** | 5-20 seashells | Log in daily |

### What to Spend Seashells On

| Item | Cost | Worth It? |
|------|------|-----------|
| **Seashell Crown** | 3 seashells (collect all 3) | Yes — exclusive headpiece |
| **Seashell Pack** | Varies | Yes — contains rare items |
| **Seashell Accessories** | 10-30 seashells | Situational — depends on your style |
...
- [Dress To Impress Codes - Beebom](https://beebom.com/roblox-dress-to-impress-codes/)
